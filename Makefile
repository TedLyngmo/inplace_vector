...
OPTS=-Weverything -fsafe-buffer-usage-suggestions -Wno-padded -Wno-exit-time-destructors -Wno-c++98-compat -Wno-c++98-compat-pedantic -Wno-c++20-compat -Wno-missing-prototypes #-Wno-ctad-maybe-unsupported
else
OPTS=-Wall -Wextra
endif
